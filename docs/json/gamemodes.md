...
# Game modes
There are currently 10 game modes in Sector's Edge. This page lists the minimum requirements to play a game mode on a map.

## Breakthrough
Breakthrough has 2 teams compete for control over stationary capture zones.
...
## Salvage
Salvage was a gamemode in which 2 teams fight over harvesting meteors that fall periodically. Salvage was removed from the game to be replaced by another similar game mode that never released. When Salvage is the active gamemode, the team information and match time HUDs disappear. The gamemode on the scoreboard is `All`, which is most likely a placeholder.

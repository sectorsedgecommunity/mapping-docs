				...
				items: [
					{ text: 'JSON file', link: '/json.md', collapsed: true, items: [
						...
						{ text: 'Game modes', link: '/json/gamemodes.md', collapsed: true, items: [
							{ text: 'Breakthrough & Control Shift', collapsed: true, items: [
							...
							{ text: 'Capture the Flag & Escort', collapsed: true, items: [
									{ text: 'FlagSpawns', link: '/json/gamemodes/flagspawns.md' },
								]
							},
							{ text: 'Free for all game modes', collapsed: true, items: [
									{ text: 'FFAPlayerSpawns', link: '/json/gamemodes/ffaplayerspawns.md' },
									{ text: 'Head Hunter: WeaponSpawns', link: '/json/gamemodes/weaponspawns.md' }
								],
							},
							{ text: 'Rush: RushStages', link: '/json/gamemodes/rushstages.md' },
							{ text: 'Static', collapsed: true, items: [
						...
						{ text: 'Team spawns', link: '/json/player_spawns.md' }
					]
					},
